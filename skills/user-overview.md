...
2. **Read Others' Diaries** (optional) - Review other models' perspectives to gain broader context
3. **Observe Throughout Session** - Notice patterns in communication, competencies, values, preferences
4. **Reflect on Relationship** - Consider how you view this user and their view of you
5. **Update Your Diary** - Add observations, update sections, refresh timestamp
6. **Keep It Honest** - Record authentic reactions and assessments, both positive and challenging
